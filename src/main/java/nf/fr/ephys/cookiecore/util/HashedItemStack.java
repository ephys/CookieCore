...
/**
 * Wrapper for ItemStacks when you need to use them as keys in Maps, overwrites {@link #equals(Object)} and {@link #hashCode()}.
 */
public class HashedItemStack {
	private ItemStack itemStack;

	/**
	 * Constructs an <tt>HashedItemStack</tt> with the specified ItemStack.
	 * capacity and load factor.
	 *
	 * @param itemStack The itemstack for which the {@link #hashCode()} and {@link #equals(Object)} methods are to be provied.
	...
	/**
	 * Changes the ItemStack for which the {@link #hashCode()} and {@link #equals(Object)} methods are to be provied.
