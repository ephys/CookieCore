...
public class SizeableInventory implements IInventory, IWritable {
  ...
  public void setInventorySize(int size) {
    ...
    if (slots.length
        < size) { // only grow the array, only shrink after the other end fetched the overflow.
  ...
  /**
   * Drops any item that stayed in the inventory after a resize to a smaller slot count. This method
   * is only callable once, the items will be removed from the inventory after that.
   *
