...
public class FlatPresetRegistry {
	...
	public static GuiFlatPresets.LayerItem buildPreset(String name, Item icon, BiomeGenBase biome, List structures, FlatLayerInfo[] layers) {
	...
	public static GuiFlatPresets.LayerItem removeByName(String name) {
		for (int i = 0; i < GuiFlatPresets.field_146431_f.size(); i++) {
			GuiFlatPresets.LayerItem preset = (GuiFlatPresets.LayerItem) GuiFlatPresets.field_146431_f.get(i);
